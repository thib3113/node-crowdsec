    ...
    describe('interceptors', () => {
        describe('logger', () => {
            ...
            it('should log the success response with duration', async () => {
                ...
                const verboseResponseSuccessInterceptor = mockAxios.interceptors.response.use.mock.calls[0][0] as (config: any) => unknown;
            ...
            it('should log the error with response', async () => {
                ...
                const verboseResponseSuccessInterceptor = mockAxios.interceptors.response.use.mock.calls[0][1] as (config: any) => unknown;
                expect(verboseResponseSuccessInterceptor).toBeDefined();
