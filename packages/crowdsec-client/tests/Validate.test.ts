...
describe('Validate.test.ts', () => {
    it('should validate function mail', () => {
        ...
        expect(Validate.mail('https://test.hmail.com')).toBeFalsy();
    });
    ...
    it('should validate function stringToBoolean', () => {
        ...
        expect(Validate.stringToBoolean('1')).toBeTruthy();
        ...
        expect(Validate.stringToBoolean('0')).toBeFalsy();
    ...
    it('should validate function isType', () => {
        expect(Validate.isType({}, true)).toBeTruthy();
        expect(Validate.isType({}, false)).toBeFalsy();
    });
});
